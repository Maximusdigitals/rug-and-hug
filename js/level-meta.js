...
const LEVEL_ENRICHMENT = {
  1: { hint: "WIN: 8 gold taps. Wait for the orb to turn gold in the center — early/late taps are misses (max 2).", voidMark: "receipt" },
  2: { hint: "WIN: 9 green gems. Green ring = tap. Red ring = rug — skip it (max 2 rugs).", voidMark: "boot" },
  3: { hint: "WIN: survive the timer. Drag the dot into the orange safe zone — walls close in over time.", voidMark: "chart" },
  4: { hint: "WIN: 8 FEAR taps. Only tap when the slider is green on the left — never tap red greed.", voidMark: "meter" },
  5: { hint: "WIN: 10 green whacks. Tap green memecoins when they pop — red RUG coins end your run.", voidMark: "ticker" },
  6: { hint: "WIN: seat 8 ghosts. Tap the floating ghost, not the pew — they fade in about 1 second.", voidMark: "pew" },
  7: { hint: "WIN: dunk PERPS 5×. Pools shuffle — only the green PERPS pool is safe. One wrong pool = fail.", voidMark: "pool" },
  8: { hint: "WIN: 7 glow taps. Only tap oil/gold/silver when they pulse — ignore dim ones.", voidMark: "barcode" },
  9: { hint: "WIN: catch 9 USDC. Drag the wallet into blue coins — dodge SEC letters and red scams (max 2 hits).", voidMark: "tv" },
  10: { hint: "WIN: 8 blue taps. Tap USDC only — let red wobbly coins fall (max 2 bad taps).", voidMark: "stamp" },
  11: { hint: "WIN: 7 shields. Wait for 👁 then tap SHIELD — tapping early or missing the eye = miss.", voidMark: "shield" },
  12: { hint: "WIN: 8 ACCEPT taps. Same rhythm as Day 1 — tap when demands hit the green line.", voidMark: "badge" },
  13: { hint: "WIN: 8 tight spreads. Tap only when YES/NO lines meet and the box glows green.", voidMark: "invite" },
  14: { hint: "WIN: 7 BUY taps. Tap only on BUY + 🚀 — ignore 'hard pass' screens.", voidMark: "vc" },
  15: { hint: "WIN: pass 6 gaps. Tap to boost through holes in the red walls — one wall hit = fail.", voidMark: "serial" },
  16: { hint: "WIN: 10 green drops. Tap green AIRDROP crates — let red FAKE ones fall untouched.", voidMark: "wristband" },
