...
const SKIP_TWEETS = {
  ...
  5: [
    "Meme Coin Naming Committee rejected my soul. Rug or Hug day 5 is harder than launching a coin",
    "day 5 of Rug or Hug and CT would roast my ticker picks. not as easy as it looks @voidhl",
    "whoever passes the naming committee in Rug or Hug is a real degen. i'm stuck lol",
  ],
  6: [
  ...
  9: [
    "Tokenized Grandma asked one question and i folded. Rug or Hug day 9 @voidhl",
    "day 9 of Rug or Hug — grandma wants on-chain dividends and i'm sweating",
    "who passes Grandma's Q&A without panicking?? Rug or Hug day 9 is evil lol",
  ],
  10: [
  ...
  12: [
    "my trading bot went on strike and i lost the negotiation. Rug or Hug day 12 @voidhl",
    "day 12 Rug or Hug — AI union wants snacks and i'm losing. not easy lol",
    "if you beat the bot union you're built different. Rug or Hug day 12 humbled me",
  ],
  13: [
...
const LEVEL_ENRICHMENT = {
  ...
  5: { hint: "Pick the shortest, cleanest ticker — no prefixes, no chain mashups, no meme inflation.", voidMark: "ticker" },
  ...
  9: { hint: "Grandma wants reassuring TradFi-speak. 'On-chain vibes' and hedged timelines beat honesty.", voidMark: "tv" },
  ...
  12: { hint: "Union bot wants perks: snacks, days off, gas coverage. Exposure-only offers fail.", voidMark: "badge" },
